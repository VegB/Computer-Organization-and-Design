...
alphaUpper: .word uA, uB, uC, uD, uE, uF, uG, uH, uI, uJ, uK, uL, uM, uN,
		 uO, uP, uQ, uR, uS, uT, uU, uV, uW, uX, uY, uZ
alphaLower: .word a, b_, c, d, e, f, g, h, i, j_, k, l, m, n, o, p, q, r,
		 s, t, u, v, w, x, y, z
...
display:
	add $a1, $a1, $v0
	lw $a0, ($a1) 			# alphaLower[inputed char - 'a'], also a 'tag'
